...
window.addEventListener("DOMContentLoaded", function()
{
    ...
    toolboxes.drawtools.innerHTML += "<block type='turtle_go_back'</block>";
	toolboxes.drawtools.innerHTML += "<block type='turtle_turn'></block>";
    toolboxes.drawtools.innerHTML += "<block type='turtle_turn_anti'></block>";
    toolboxes.drawtools.innerHTML += "<block type='block_raiseneck'></block>";
    toolboxes.drawtools.innerHTML += "<block type='block_moveneck'></block>";
    toolboxes.drawtools.innerHTML += "<block type='block_lowerneck'></block>";
    toolboxes.drawtools.innerHTML += "<block type='block_fmoveparam'></block>";
    toolboxes.drawtools.innerHTML += "<block type='block_bmoveparam'></block>";
    
	toolboxes.control = document.createElement("xml");
	toolboxes.control.innerHTML += "<block type='turtle_if'></block>";
	toolboxes.control.innerHTML += "<block type='turtle_ifelse'></block>";
    toolboxes.control.innerHTML += "<block type='turtle_conditionals'></block>";
    toolboxes.control.innerHTML += "<block type='turtle_andor'></block>";
	
	toolboxes.loops = document.createElement("xml");
    toolboxes.loops.innerHTML += "<block type='turtle_repeat_times'></block>";
	toolboxes.loops.innerHTML += "<block type='turtle_repeat'></block>";
	toolboxes.loops.innerHTML += "<block type='turtle_forever'></block>";
    toolboxes.loops.innerHTML += "<block type='turtle_for_loop'></block>";
    
	toolboxes.math = document.createElement("xml");
	toolboxes.math.innerHTML += "<block type='block_math'></block>";
    toolboxes.math.innerHTML += "<block type='block_even'></block>";
    
    toolboxes.looks = document.createElement("xml");
	toolboxes.looks.innerHTML += "<block type='block_speak'></block>";
    toolboxes.looks.innerHTML += "<block type='block_speaksec'></block>";
	...
	scrollx.style.width = (1000 - ((1000 - window.innerWidth) * 2)) - 10 + "px"; // set scrollbar dimensions
	scrolly.style.height = (1000 - ((1000 - window.innerHeight) * 2)) - 10 + "px";
	ox = (20 - window.innerWidth) /2; // set initial scroll offset
	oy = (20 - window.innerHeight) /2;
